...
export DOCKER_REPOSITORY="891377231136.dkr.ecr.ap-northeast-1.amazonaws.com"

#Tag and push the basis bot image.
docker login -u AWS -p $(aws ecr get-login-password --region ${AWS_REGION} --profile ProdEng) ${DOCKER_REPOSITORY}
