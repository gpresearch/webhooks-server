...
class MeteoraClient:
    ...
    DEFAULT_POOL_PUB_KEY = "BVRbyLjjfSBcoyiYFuxbgKYnWuiFaF9CSXEa5vdSZ9Hh"

    def __init__(self):
        pass

    def create_add_liquidity_tx(self):
        RPC = "https://api.mainnet-beta.solana.com"
        pool_address = Pubkey.from_string(self.DEFAULT_POOL_PUB_KEY)
        print(str(pool_address))
        client = Client(RPC)
...
if __name__ == "__main__":
    ...
    client.create_add_liquidity_tx()